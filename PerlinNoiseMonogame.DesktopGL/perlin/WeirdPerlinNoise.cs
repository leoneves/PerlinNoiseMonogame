...
{
    class WeirdPerlinNoise
    {
        static Random random = new Random();

        private void DemoImageBlend()
        {
            // int octaveCount = 8;
        ...
        public Color Interpolate(Color col0, Color col1, float alpha)
        {
            float beta = 1 - alpha;
        ...
        private Color[][] MapToGrey(float[][] greyValues)
        {
        ...
        public Color[][] BlendImages(Color[][] image1, Color[][] image2, float[][] perlinNoise)
        {
            int width = image1.Length;
            int height = image1[0].Length;
        ...
        private Color[][][] AnimateTransition(Color[][] image1, Color[][] image2, int frameCount)
        {
